...
/**
 * This is the model class for table "sys_storagegeneralinfo".
 *
 * The followings are the available columns in table 'sys_storagegeneralinfo':
 * @property integer $id
...
class Storagegeneralinfo extends CActiveRecord
{
	 ...
	 * @return Storagegeneralinfo the static model class
	 */
	...
	{
		return 'sys_storage_general_info';
	}
