...
CREATE TABLE `dt_letters_version` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fileFormatId` int(11) DEFAULT NULL,
  ...
  CONSTRAINT `dt_letters_version_ibfk_1` FOREIGN KEY (`fileFormatId`) REFERENCES `sys_fileFormats` (`id`),
...
CREATE TABLE `dt_notices_version` (
  ...
  KEY `fileFormatId` (`fileFormatId`),
  KEY `updateUserId` (`updateUserId`),
  CONSTRAINT `dt_notices_version_ibfk_1` FOREIGN KEY (`fileFormatId`) REFERENCES `sys_fileFormats` (`id`),
...
CREATE TABLE `sys_documents` (
  ...
  KEY `updateUserId` (`updateUserId`),
  CONSTRAINT `sys_documents_ibfk_1` FOREIGN KEY (`typeId`) REFERENCES `sys_documentTypes` (`id`),
  CONSTRAINT `sys_documents_ibfk_2` FOREIGN KEY (`fileFormatId`) REFERENCES `sys_fileFormats` (`id`),
...
CREATE TABLE `sys_folders` (
  ...
  CONSTRAINT `sys_folders_ibfk_2` FOREIGN KEY (`typeId`) REFERENCES `sys_folderTypes` (`id`),
  CONSTRAINT `sys_folders_ibfk_3` FOREIGN KEY (`contentTypeId`) REFERENCES `sys_folderContentTypes` (`id`),
  CONSTRAINT `sys_folders_ibfk_4` FOREIGN KEY (`documentTypeId`) REFERENCES `sys_documentTypes` (`id`),
